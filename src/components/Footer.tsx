  ...
  return (
    <footer className='container-fluid w-100 p-0'>
        <div className='container-xl row justify-content-between align-items-start m-auto'>
            ...
            <div className='col-md-4 flex flex-column align-items-start'>
                <h1 className="text-align-left fw-bold" style={{ fontSize: "1.5rem", lineHeight: 1.2 }}>Quick Links</h1>
                <section className="navbar-nav nav-underline d-flex align-items-start gap-1">
                    <a className="nav-item nav-link link-offset-0" href="#">
                        Home
                    </a>
                    <a className="nav-item nav-link link-offset-0" href="#">
                        About
        ...
        <div className="container-fluid mt-3 bg-light text-dark py-5 d-flex flex-column align-items-center justify-content-center w-100" style={{ rowGap: 30, clear: "both" }}>
            <a
                className="d-flex align-items-center justify-content-center text-decoration-none bg-dark text-white px-4 py-2 rounded mb-2 fw-semibold"
                rel="nofollow"
                href="https://graphy.com/products/create-and-sell-course-online?utm_campaign=brainicacademy&utm_source=gc&utm_device=website&gref=brainicacademy"
                target="_blank"
            ...
            <div className="text-center" style={{ fontSize: 12, fontWeight: 400, lineHeight: "20px", letterSpacing: "0.015em" }}>
                100K+ creators trust{" "}
                <a
                    href="https://graphy.com/products/create-and-sell-course-online?utm_campaign=brainicacademy&utm_source=gc&utm_device=website&gref=brainicacademy"
                    target="_blank"
            ...
            <div className="d-flex align-items-center justify-content-center gap-3 my-2">
                <a
                    href="https://www.youtube.com/c/GraphyUniversity"
                    className="d-flex align-items-center justify-content-center border rounded"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: "#000", height: 24, width: 24, fontSize: 16 }}
                >
            ...
            <div className="d-flex align-items-center justify-content-center flex-wrap gap-3" style={{ fontSize: 14, fontWeight: 500, lineHeight: "20px", letterSpacing: "0.015em" }}>
                <span>
                    Brainic Academy <i className="fa-regular fa-copyright"></i> 2025
                </span>
                <i className="fa-solid fa-circle" style={{ fontSize: 4 }}></i>
                <a href="/privacypolicy" className="text-dark text-decoration-underline" style={{ padding: 0, fontSize: "inherit" }}>
                    Privacy policy
                </a>
                <i className="fa-solid fa-circle" style={{ fontSize: 4 }}></i>
                <a href="/termsofuse" className="text-dark text-decoration-underline" style={{ padding: 0, fontSize: "inherit" }}>
                    Terms of use
                </a>
                <i className="fa-solid fa-circle" style={{ fontSize: 4 }}></i>
                <a href="/contactus" className="text-dark text-decoration-underline" style={{ padding: 0, fontSize: "inherit" }}>
                    Contact us
                </a>
                <i className="fa-solid fa-circle" style={{ fontSize: 4 }}></i>
                <a href="/refundpolicy" className="text-dark text-decoration-underline" style={{ padding: 0, fontSize: "inherit" }}>
                    Refund policy
                </a>
            </div>
        </div>
